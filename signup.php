<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $gender= mysqli_real_escape_string($connection,strtolower($_POST['gender']));
        $permanentaddress= mysqli_real_escape_string($connection,strtolower($_POST['Permanentaddress']));
        $telephone= mysqli_real_escape_string($connection,strtolower($_POST['Telephone']));
        ...
        $signup_query= "INSERT INTO `user`(`user_id`, `first_name`, `last_name`, `email`,`gender`,`permanentaddress`,`telephone`, `username`, `password`) VALUES ('','$firstname','$lastname','$email','$gender','$permanentaddress','$telephone','$username','$password')";
        ...
        <div class="col-md-6">
           <?php echo $msg; ?>
            <div class="page-header">
                <h1 style="text-align: center;">Driver's  details</h1>
          </div>
            <form class="form-horizontal animated bounce" action="" method="post">
               ...
               <br>
                ...
                <div class="input-group">
                 <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                 <input id="Permanentaddress" type="text" class="form-control" name="Permanentaddress" placeholder="Permanent address">
               </div>
               <br>
               <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
